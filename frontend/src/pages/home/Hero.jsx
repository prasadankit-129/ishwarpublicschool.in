  ...
  return (
    <section className="relative overflow-hidden">
      <div
        ...
        style="background-image:url(frontend\public\assets\images\hero-campus.jpg);"
      />
      <div className="absolute inset-0 hero-gradient" />
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-36 text-white">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur border border-white/20 text-xs uppercase tracking-widest mb-6 animate-rise-in" data-testid="hero-badge">
          <Sparkles className="w-3 h-3 text-brand-gold" />
          Nurturing Excellence Since 2002
        </div>
        <h1 className="font-display text-4xl sm:text-5xl lg:text-7xl font-bold max-w-4xl leading-[1.05] animate-rise-in delay-100" data-testid="hero-title">
          Where every child <em className="text-brand-gold not-italic">dreams boldly</em> and grows gracefully.
        </h1>
        <p className="mt-6 max-w-2xl text-base md:text-lg text-white/85 leading-relaxed animate-rise-in delay-200" data-testid="hero-subtitle">
        ...
        <div className="mt-10 flex flex-wrap gap-4 animate-rise-in delay-300">

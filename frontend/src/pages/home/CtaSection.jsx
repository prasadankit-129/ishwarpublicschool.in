        ...
        <div className="relative overflow-hidden rounded-3xl bg-brand-navy p-10 md:p-16 text-white">
          ...
          <div className="relative grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex md:justify-end">
              <Link to="/admissions" className="shine-link inline-flex items-center gap-2 px-8 py-4 bg-brand-ochre hover:bg-brand-gold hover:text-brand-navy font-semibold rounded-full shadow-lg transition-all" data-testid="cta-apply">

        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <Link
              ...
              className="px-5 py-2 rounded-full bg-brand-ochre text-white font-semibold text-sm hover:bg-brand-ochre/90 transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5"
            >
